...
public interface LedsIO {
  ...
  public static enum LedMode {
    CLIMB_NORMAL, CLIMB_FAILURE, CLIMB_SUCCESS, AUTO_ALERT, SHOOTING, TARGETED, TOWER_FULL, INTAKING, DEFAULT_AUTO, DEFAULT_TELEOP, DISABLED_RED, DISABLED_BLUE, DISABLED_NEUTRAL
  }
}
