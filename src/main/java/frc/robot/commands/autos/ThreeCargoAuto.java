...
public class ThreeCargoAuto extends SequentialCommandGroup {
  public static Pose2d tarmacDCTurnPosition =
      TwoCargoAuto.cargoPositions
          ...
          .transformBy(new Transform2d(new Translation2d(), Rotation2d.fromDegrees(-120.0)));
  public static Pose2d tarmacCCargoPosition =
      FieldConstants.cargoD.transformBy(
          new Transform2d(new Translation2d(-0.2, 0.2), Rotation2d.fromDegrees(-45.0)));
  public static Pose2d tarmacCShootPosition =
      TwoCargoAuto.calcAimedPose(
          tarmacCCargoPosition.transformBy(GeomUtil.transformFromTranslation(-0.5, -0.1)));
  ...
  public ThreeCargoAuto(
    ...
    addCommands(
        ...
        deadline(
            ...
            new PrepareShooterAuto(flywheels, hood, feeder, tarmacCShootPosition.getTranslation())),
