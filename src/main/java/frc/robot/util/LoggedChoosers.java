...
public class LoggedChoosers extends SubsystemBase {
  ...
  public LoggedChoosers() {
    ...
    addOptions(autoRoutineChooser, List.of("Do Nothing", "Crazy duck (TA*)",
        "Fast crazy duck (TA*)", "Duck to hangar (TB)", "Duck to hangar (FA)",
        "Wait + short duck taxi (TB)", "Wait + long duck taxi (TB)",
